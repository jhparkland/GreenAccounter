...
class FireBase:
    def __init__(self, model, name):
        ...
        self.resource_file_path = f"{self.path}/file/resource.json" 
    ...
    def upload_current_resource(self, used_cpu, used_memory, total_memory, used_gpu, total_gpu, epoch, clock, max_clock, learning_time, carbon_emission, carbons, epoch_no):
        bucket = storage.bucket(app=self.firebase_app)
